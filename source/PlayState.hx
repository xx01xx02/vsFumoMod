			...
			case 'fumo':
				{
						defaultCamZoom = 0.7;
						curStage = 'fumo';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('fumobg'));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						add(bg);

						var stageFront:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('fumopillar'));
						stageFront.setGraphicSize(Std.int(stageFront.width * 1.1));
						stageFront.updateHitbox();
						stageFront.antialiasing = true;
						stageFront.scrollFactor.set(0.9, 0.9);
			...
			case 'hell':
				{
						defaultCamZoom = 0.7;
						curStage = 'hell';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('fefebg'));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						add(bg);

						var stageFront:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('fefepillar'));
						stageFront.setGraphicSize(Std.int(stageFront.width * 1.1));
						stageFront.updateHitbox();
						stageFront.antialiasing = true;
						stageFront.scrollFactor.set(0.9, 0.9);
